...
class DASH_Downloader:
    ...
    def parse_manifest(self, custom_headers):
        ...
        def calculate_column_widths():
            ...
            # Video info - get resolution dynamically
            selected_video, list_available_resolution, filter_custom_resolution, downloadable_video = self.parser.select_video(get_force_resolution())
