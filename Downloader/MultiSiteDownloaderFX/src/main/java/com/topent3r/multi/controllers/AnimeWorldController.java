...
import com.topent3r.multi.services.AnimeWorldProvider;
...
public class AnimeWorldController {
    ...
    private final ContentProvider provider = new AnimeWorldProvider();
