...
import com.topent3r.multi.services.MediasetInfinityProvider;
...
public class MediasetInfinityController {
    ...
    private final ContentProvider provider = new MediasetInfinityProvider();
