...
import com.topent3r.multi.services.RaiPlayProvider;
...
public class RaiPlayController {
    ...
    private final ContentProvider provider = new RaiPlayProvider();
