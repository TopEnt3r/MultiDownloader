...
import com.topent3r.multi.services.AnimeUnityProvider;
...
public class AnimeUnityController {
    ...
    private final ContentProvider provider = new AnimeUnityProvider();
